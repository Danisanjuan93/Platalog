...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_user_registration' => 'getAppUserRegistrationService',
            ...
            'entity_model_activity' => 'getEntityModelActivityService',
            'entity_model_finca' => 'getEntityModelFincaService',
            'entity_model_fincaregister' => 'getEntityModelFincaregisterService',
            'entity_model_historic' => 'getEntityModelHistoricService',
            'entity_model_note' => 'getEntityModelNoteService',
            'entity_model_orders' => 'getEntityModelOrdersService',
            'entity_model_parcel' => 'getEntityModelParcelService',
            'entity_model_parcelregister' => 'getEntityModelParcelregisterService',
            'entity_model_user_app' => 'getEntityModelUserAppService',
            'entity_model_vehicle' => 'getEntityModelVehicleService',
            ...
            'security.user_checker.register' => 'getSecurity_UserChecker_RegisterService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.api' => 'security.user_checker.register',
            'security.user_checker.main' => 'security.user_checker.register',
    ...
    /**
     * Gets the public 'app_user_registration' shared service.
     *
     * @return \EntityBundle\Form\RegistrationType
     */
    protected function getAppUserRegistrationService()
    {
        return $this->services['app_user_registration'] = new \EntityBundle\Form\RegistrationType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'platalog', 'user' => 'platalog', 'password' => 'v1QxanPQ', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/EntityBundle/Entity'))), 'EntityBundle\\Entity');
        $b->addDriver($a, 'FOS\\UserBundle\\Entity');
        $b->addDriver($a, 'FOS\\OAuthServerBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('EntityBundle' => 'EntityBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'FOSOAuthServerBundle' => 'FOS\\OAuthServerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_1dbd1ef8d6c4ce4b1e5b7ead6c856c1309968d9e6a52dc8bb79f0b0d80922db6');
    ...
    /**
     * Gets the public 'entity_model_activity' shared service.
     *
     * @return \EntityBundle\Model\ActivityModel
     */
    protected function getEntityModelActivityService()
    {
        return $this->services['entity_model_activity'] = new \EntityBundle\Model\ActivityModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_finca' shared service.
     *
     * @return \EntityBundle\Model\FincaModel
     */
    protected function getEntityModelFincaService()
    {
        return $this->services['entity_model_finca'] = new \EntityBundle\Model\FincaModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_fincaregister' shared service.
     *
     * @return \EntityBundle\Model\FincaRegisterModel
     */
    protected function getEntityModelFincaregisterService()
    {
        return $this->services['entity_model_fincaregister'] = new \EntityBundle\Model\FincaRegisterModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_historic' shared service.
     *
     * @return \EntityBundle\Model\HistoricModel
     */
    protected function getEntityModelHistoricService()
    {
        return $this->services['entity_model_historic'] = new \EntityBundle\Model\HistoricModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_note' shared service.
     *
     * @return \EntityBundle\Model\NoteModel
     */
    protected function getEntityModelNoteService()
    {
        return $this->services['entity_model_note'] = new \EntityBundle\Model\NoteModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_orders' shared service.
     *
     * @return \EntityBundle\Model\OrdersModel
     */
    protected function getEntityModelOrdersService()
    {
        return $this->services['entity_model_orders'] = new \EntityBundle\Model\OrdersModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_parcel' shared service.
     *
     * @return \EntityBundle\Model\ParcelModel
     */
    protected function getEntityModelParcelService()
    {
        return $this->services['entity_model_parcel'] = new \EntityBundle\Model\ParcelModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_parcelregister' shared service.
     *
     * @return \EntityBundle\Model\ParcelRegisterModel
     */
    protected function getEntityModelParcelregisterService()
    {
        return $this->services['entity_model_parcelregister'] = new \EntityBundle\Model\ParcelRegisterModel($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'entity_model_user_app' shared service.
     *
     * @return \EntityBundle\Model\UserAppModel
     */
    protected function getEntityModelUserAppService()
    {
        return $this->services['entity_model_user_app'] = new \EntityBundle\Model\UserAppModel($this->get('doctrine.orm.default_entity_manager'), $this->get('fos_user.user_manager'));
    }

    /**
     * Gets the public 'entity_model_vehicle' shared service.
     *
     * @return \EntityBundle\Model\VehicleModel
     */
    protected function getEntityModelVehicleService()
    {
        return $this->services['entity_model_vehicle'] = new \EntityBundle\Model\VehicleModel($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['fos_oauth_server.access_token_manager.default'] = new \FOS\OAuthServerBundle\Entity\AccessTokenManager($this->get('fos_oauth_server.entity_manager'), 'EntityBundle\\Entity\\OAuth\\AccessToken');
    }
    ...
    {
        return $this->services['fos_oauth_server.auth_code_manager.default'] = new \FOS\OAuthServerBundle\Entity\AuthCodeManager($this->get('fos_oauth_server.entity_manager'), 'EntityBundle\\Entity\\OAuth\\AuthCode');
    }
    ...
    {
        return $this->services['fos_oauth_server.client_manager.default'] = new \FOS\OAuthServerBundle\Entity\ClientManager($this->get('fos_oauth_server.entity_manager'), 'EntityBundle\\Entity\\OAuth\\Client');
    }
    ...
    {
        return $this->services['fos_oauth_server.refresh_token_manager.default'] = new \FOS\OAuthServerBundle\Entity\RefreshTokenManager($this->get('fos_oauth_server.entity_manager'), 'EntityBundle\\Entity\\OAuth\\RefreshToken');
    }
    ...
    {
        return $this->services['fos_oauth_server.server'] = new \OAuth2\OAuth2($this->get('fos_oauth_server.storage'), array('access_token_lifetime' => 86400, 'refresh_token_lifetime' => 15552000));
    }
    ...
    {
        return $this->services['fos_rest.form.extension.csrf_disable'] = new \FOS\RestBundle\Form\Extension\DisableCSRFExtension($this->get('security.token_storage'), 'IS_AUTHENTICATED_ANONYMOUSLY', $this->get('security.authorization_checker'));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/doc', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html'), 'fallback_format' => 'html', 'prefer_extension' => false, 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('info@platalog.com' => 'Platalog'), 'resetting' => array('info@platalog.com' => 'Platalog'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('EntityBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'EntityBundle\\Form\\UsersType', NULL, array('validation_groups' => array(0 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('EntityBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.context'), $this->get('security.user_checker.register'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'EntityBundle\\Entity\\Users');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'EntityBundle' => ($this->targetDirs[3].'/src/EntityBundle/Resources/config/serializer'), 'ApiBundle' => ($this->targetDirs[3].'/src/ApiBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[2].'/Resources/FOSUserBundle/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'FOS\\OAuthServerBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/config/serializer'), 'CommandBundle' => ($this->targetDirs[3].'/src/CommandBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.register' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/registers'), 'security.firewall.map.context.oauth_token' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/oauth/v2/token'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/*'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \FOS\OAuthServerBundle\Security\Firewall\OAuthListener($a, $this->get('security.authentication.manager'), $this->get('fos_oauth_server.server')), 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', $this->get('fos_oauth_server.security.entry_point'), NULL, NULL, $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), true));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($d, $a, array(), $e);
        $g->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout')), 2 => new \FOS\OAuthServerBundle\Security\Firewall\OAuthListener($b, $c, $this->get('fos_oauth_server.server')), 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $c, $this->get('security.authentication.session_strategy'), $a, 'main', $f, $g, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $e, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a1db0263634e2.08306047', $e, $c), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($d, $a, '/login', false), NULL, NULL, $e, true));
    }
    ...
    /**
     * Gets the public 'security.firewall.map.context.register' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_RegisterService()
    {
        ...
        return $this->services['security.firewall.map.context.register'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \FOS\OAuthServerBundle\Security\Firewall\OAuthListener($a, $b, $this->get('fos_oauth_server.server')), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a1db0263634e2.08306047', $c, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'register', $this->get('fos_oauth_server.security.entry_point'), NULL, NULL, $c, true));
    }
    ...
    /**
     * Gets the public 'security.user_checker.register' shared service.
     *
     * @return \Symfony\Component\Security\Core\User\UserChecker
     */
    protected function getSecurity_UserChecker_RegisterService()
    {
        return $this->services['security.user_checker.register'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CommandBundle/Resources/views'), 'FOSOAuthServer');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/views'), 'FOSOAuthServer');
        $instance->addPath(($this->targetDirs[3].'/src/CommandBundle/Resources/views'), 'Command');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $c = $this->get('security.user_checker.register');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \FOS\OAuthServerBundle\Security\Authentication\Provider\OAuthProvider($a, $b, $c), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a1db0263634e2.08306047'), 2 => new \FOS\OAuthServerBundle\Security\Authentication\Provider\OAuthProvider($a, $b, $c), 3 => new \FOS\OAuthServerBundle\Security\Authentication\Provider\OAuthProvider($a, $b, $c), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'main', $this->get('security.encoder_factory'), true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a1db0263634e2.08306047')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_APP')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CommandBundle' => 'CommandBundle\\CommandBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'EntityBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/EntityBundle'),
                ...
                'CommandBundle' => array(
                    'parent' => 'FOSOAuthServerBundle',
                    'path' => ($this->targetDirs[3].'/src/CommandBundle'),
            ...
            'database_port' => 3306,
            'database_name' => 'platalog',
            'database_user' => 'platalog',
            'database_password' => 'v1QxanPQ',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'project_email' => 'info@platalog.com',
            'project_name' => 'Platalog',
            'locale' => 'en',
            ...
            'fos_user.model.user.class' => 'EntityBundle\\Entity\\Users',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'info@platalog.com' => 'Platalog',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'EntityBundle\\Form\\UsersType',
            ...
            'fos_oauth_server.server.options' => array(
                ...
                'refresh_token_lifetime' => 15552000,
            ),
            'fos_oauth_server.model_manager_name' => NULL,
            'fos_oauth_server.model.client.class' => 'EntityBundle\\Entity\\OAuth\\Client',
            'fos_oauth_server.model.access_token.class' => 'EntityBundle\\Entity\\OAuth\\AccessToken',
            'fos_oauth_server.model.refresh_token.class' => 'EntityBundle\\Entity\\OAuth\\RefreshToken',
            'fos_oauth_server.model.auth_code.class' => 'EntityBundle\\Entity\\OAuth\\AuthCode',
